...
const releaseRoot = '/home/customer/staging-safety/staging-remediation-r18-20260717';
...
test('deployment source fixes application identity, paths, safe transport, and one attempt', () => {
  ...
  assert.match(nodeSource, /path\.join\(stateParent, 'staging-remediation-r18-20260717'\)/);
