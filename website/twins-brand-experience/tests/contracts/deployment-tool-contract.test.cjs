...
const releaseRoot = '/home/customer/staging-safety/staging-remediation-r35-20260820';
...
test('deployment source fixes application identity, paths, safe transport, and one attempt', () => {
  ...
  assert.match(nodeSource, /path\.join\(stateParent, 'staging-remediation-r35-20260820'\)/);
