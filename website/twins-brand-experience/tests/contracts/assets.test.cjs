...
test('owned originals remain exact and every derivative is manifested', () => {
  ...
  assert.deepEqual(manifest.assets.map(a => a.logicalName), ['truck-cutout', 'crew-fleet', 'tal-portrait', 'technician-at-work', 'daniel-portrait', 'charles-portrait', 'maurice-portrait', 'nicholas-portrait']);
