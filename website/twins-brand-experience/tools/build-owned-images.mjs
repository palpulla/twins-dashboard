...
const specs = [
  { logicalName: 'truck-cutout', original: 'assets/images/brand/twins-service-truck-cutout.png', sourceLocator: 'website/staging-safety/mu-plugins/twins-staging-assets/twins-service-truck-cutout.png', sourceEvidence: 'r30 adapters reference 320w/880w derivatives that never existed; generated 2026-08-20', widths: [320, 880, 1280], alt: 'Twins Garage Doors branded service truck' },
