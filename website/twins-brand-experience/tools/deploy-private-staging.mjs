...
const TRANSACTION_ROOT = '/home/customer/staging-safety/staging-remediation-r10-20260717';
...
const stateRoot = path.join(stateParent, 'staging-remediation-r10-20260717');
