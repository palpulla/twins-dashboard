...
const TRANSACTION_ROOT = '/home/customer/staging-safety/staging-header-guard-r2-20260717';
...
const stateRoot = path.join(stateParent, 'staging-header-guard-r2-20260717');
