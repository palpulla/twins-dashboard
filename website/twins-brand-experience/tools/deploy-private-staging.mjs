...
const TRANSACTION_ROOT = '/home/customer/staging-safety/staging-remediation-r47-20260827';
...
const stateRoot = path.join(stateParent, 'staging-remediation-r47-20260827');
