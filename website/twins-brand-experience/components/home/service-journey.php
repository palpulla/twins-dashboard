...
<section class="twins-brand-service-journey" data-home-scene="service-journey" data-home-service-journey data-home-motion aria-labelledby="twins-brand-journey-title" data-home-reveal>
  ...
  <ol>
    <li class="twins-brand-journey-step">
      <div class="twins-brand-journey-stage twins-brand-journey-stage--twin" aria-hidden="true">
        <img class="twins-brand-journey-twin" src="<?= htmlspecialchars($experience->asset('twin-left'), ENT_QUOTES, 'UTF-8') ?>" width="196" height="534" alt="" aria-hidden="true" loading="lazy" decoding="async">
      </div>
      <div class="twins-brand-journey-card">
    ...
    <li class="twins-brand-journey-step">
      <div class="twins-brand-journey-stage twins-brand-journey-stage--photo">
      <?php
    ...
    <li class="twins-brand-journey-step">
      <div class="twins-brand-journey-stage twins-brand-journey-stage--door" aria-hidden="true">
        <?= twins_brand_door_art('door-open', 'twins-brand-journey-door', 'journey') ?>
      </div>
      <div class="twins-brand-journey-card">
