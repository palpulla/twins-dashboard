...
- Throttle all page fetches ≥6s apart. Anonymous curl from this machine is firewall-blocked (BlogVault, IP 50.170.77.66) — verify logged-in only; anonymous verification stays PENDING in the change-log.
