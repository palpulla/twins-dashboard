...
- **STILL OPEN (Daniel round-2):** #3 embed the interactive door builder on the collection page 6065 (currently only a "Design Your Door" link to /design-your-door/). Builder = snippet 7127 app, supports `/door-builder/?product={id}`. This is a PAGE-CONTENT feature (not chrome) — needs the builder embed mechanism + Gallery Steel product id, added to page 6065 body. Not yet done.
