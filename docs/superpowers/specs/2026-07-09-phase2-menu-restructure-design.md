...
- Anonymous cached-output verification stays **PENDING** until Daniel whitelists IP 50.170.77.66 at app.blogvault.net (BlogVault firewall, carried from Phase 1 change-log row P2).
