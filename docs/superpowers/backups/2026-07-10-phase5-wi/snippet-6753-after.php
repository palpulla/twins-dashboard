...
<script>
(function(){
  // CAP: unify stray phone numbers to the WI line (608) 420-2377
  document.querySelectorAll('a[href*="8338332010"], a[href*="833-2010"], a[href*="6088888785"], a[href*="888-8785"]').forEach(function(a){
    a.setAttribute('href','tel:+16084202377');
    if(/833/.test(a.textContent)) a.textContent = a.textContent.replace(/\(?833\)?[ -.]?833[ -.]?2010/g,'(608) 420-2377');
    if(/888[ -.]?8785/.test(a.textContent)) a.textContent = a.textContent.replace(/\(?608\)?[ -.]?888[ -.]?8785/g,'(608) 420-2377');
  });
})();
</script>